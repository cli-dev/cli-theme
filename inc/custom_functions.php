...
function displaySocialProfiles($icon_type, $extra_class) {
  ...
  if($facebook){
    if($type_of_icon === 'icon1'){
      ...
      $facebookCode = '<div class="social-icon facebook"><a href="' . $facebook  . '" target="_blank">' . $facebookSVG . '</a></div>';  
    }
  ...
  if($twitter){
    if($type_of_icon === 'icon1'){
      ...
      $twitterCode = '<div class="social-icon twitter"><a href="' . $twitter  . '" target="_blank">' . $twitterSVG . '</a></div>';  
    }
  ...
  if($google){
    if($type_of_icon === 'icon1'){
      ...
      $googleCode = '<div class="social-icon google"><a href="' . $google  . '" target="_blank">' . $googleSVG . '</a></div>';  
    }
  ...
  if($linkedin){
    if($type_of_icon === 'icon1'){
      ...
      $linkedinCode = '<div class="social-icon linkedin"><a href="' . $linkedin  . '" target="_blank">' . $linkedinSVG . '</a></div>';  
    }
  ...
  if($tumblr){
    if($type_of_icon === 'icon1'){
      ...
      $tumblrCode = '<div class="social-icon tumblr"><a href="' . $tumblr  . '" target="_blank">' . $tumblrSVG . '</a></div>'; 
    }
  ...
  if($pinterest){
    if($type_of_icon === 'icon1'){
      ...
      $pinterestCode = '<div class="social-icon pinterest"><a href="' . $pinterest  . '" target="_blank">' . $pinterestSVG . '</a></div>'; 
    }
  ...
  if($flickr){
    if($type_of_icon === 'icon1'){
      ...
      $flickrCode = '<div class="social-icon flickr"><a href="' . $flickr  . '" target="_blank">' . $flickrSVG . '</a></div>';  
    }
  ...
  if($newswire){
    if($type_of_icon === 'icon1'){
      ...
      $newswireCode = '<div class="social-icon newswire"><a href="' . $newswire  . '" target="_blank">' . $newswireSVG . '</a></div>';  
    }
  ...
  if($instagram){
    if($type_of_icon === 'icon1'){
      ...
      $instagramCode = '<div class="social-icon instagram"><a href="' . $instagram  . '" target="_blank">' . $instagramSVG . '</a></div>';  
    }
  ...
  if($youtube){
    if($type_of_icon === 'icon1'){
      ...
      $youtubeCode = '<div class="social-icon youtube"><a href="' . $youtube  . '" target="_blank">' . $youtubeSVG . '</a></div>';  
    }
  ...
  if($vimeo){
    if($type_of_icon === 'icon1'){
      ...
      $vimeoCode = '<div class="social-icon vimeo"><a href="' . $vimeo  . '" target="_blank">' . $vimeoSVG . '</a></div>';  
    }
