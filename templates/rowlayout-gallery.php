<?php 
  ...
  $spacing_between_images = get_sub_field('spacing_between_images', $item_id);
  
  $gallery_negative_margin = ($spacing_between_images) ? ' style="margin: -' . $spacing_between_images . 'px"' : '';
  $gallery_spacing = ($spacing_between_images) ? ' style="padding: ' . $spacing_between_images . 'px"' : ''; 
